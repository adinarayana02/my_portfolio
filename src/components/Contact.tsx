        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="space-y-6">
              {[
                { icon: Mail, label: 'Email', value: 'thotaadinarayana02@gmail.com', href: 'mailto:thotaadinarayana02@gmail.com' },
                { icon: Phone, label: 'Phone', value: '+91 8309871401', href: 'tel:+918309871401' },
            ...
            <div className="flex gap-4 pt-6">
              {[
                { icon: Github, href: 'https://github.com/thotaadinarayana02', label: 'GitHub' },
                { icon: Linkedin, href: 'https://www.linkedin.com/in/thota-adinarayana/', label: 'LinkedIn' },
                { icon: ExternalLink, href: '#', label: 'Portfolio' },
                { icon: Mail, href: 'mailto:thotaadinarayana02@gmail.com', label: 'Email' },
