    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-slate-950 via-purple-950 to-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        >
          ...
          >
            <img 
              src="https://avatars.githubusercontent.com/u/97646075?v=4" 
              alt="Avatar" 
          ...
          {/* Enhanced CTA Buttons with Sophisticated Animations */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            {[
              { icon: Github, href: 'https://github.com/adinarayana02', label: 'GitHub', color: 'hover:bg-purple-500/20' },
              { icon: Linkedin, href: 'https://www.linkedin.com/in/thota-adinarayana/', label: 'LinkedIn', color: 'hover:bg-emerald-500/20' },
              { icon: Mail, href: 'mailto:thotaadinarayana02@gmail.com', label: 'Email', color: 'hover:bg-purple-500/20' },
